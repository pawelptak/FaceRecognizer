...
def recognize(img, recognizer: cv2.face_LBPHFaceRecognizer):
    ...
    dic = create_label_dictionary('../detections')
...
if __name__ == '__main__':
    ...
    recognize('../Images/nieznany.jpg',recognizer)
    recognize('../Images/dor.jpg', recognizer)
    recognize('../Images/nieznany2.jpg', recognizer)
    recognize('../Images/add.png', recognizer)
